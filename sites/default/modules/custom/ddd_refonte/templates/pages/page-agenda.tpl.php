<div class="col-xs-12 col-sm-12">
	<div id="month-name">
		<h2><?php print $vars['name_month'];?> <?php print $vars['name_year'];  ?></h2>
	</div>
</div>
<div class="agenda col-md-12">
	<div class="prec-agenda col-xs-4 col-sm-4">
		...
		<p class="prec"><?php print t('Navigate to previous month'); ?></p>
		</a>
	</div>
	<div class="prec-agenda col-xs-4 col-sm-4 col-xs-offset-4 col-sm-offset-4">
		...
		<p class="prec"><?php print t('Navigate to next month'); ?></p>
		</a>
	</div>
</div>
<?php print $vars['view']; ?>
