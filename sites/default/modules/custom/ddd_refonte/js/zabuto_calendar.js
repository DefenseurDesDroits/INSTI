...
$.fn.zabuto_calendar = function (options) {
    ...
    this.each(function () {
        ...
        function appendMonthHeader($calendarElement, $tableObj, year, month) {
            ...
            var $prevMonthNavIcon = $('<span><span class="fa fa-arrow-circle-left"></span></span>');
            var $nextMonthNavIcon = $('<span><span class="fa fa-arrow-circle-right"></span></span>');
        ...
        function ajaxEvents($calendarElement, year, month) {
            ...
            $.ajax({
                ...
                beforeSend: function( xhr ) {
                    $('#events').html('<i class="fa fa-refresh fa-spin fa-3x fa-fw margin-bottom"></i>');
                },
        ...
        function drawEvents($calendarElement, type) {
            ...
            if (events !== false) {
                $(events).each(function (index, value) {
                    ...
                    $('#events').append('<div class="content-event"><p class="event-date">' + value.title + '</p><p class="event-body">' + value.body + '</p></div>');
