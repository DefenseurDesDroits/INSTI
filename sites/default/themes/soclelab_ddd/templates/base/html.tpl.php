...
<body class="<?php print $classes; ?> <?php print "lang-" . getCurLang(); ?>" <?php print $attributes;?>>
  <div id="top-link">
    <a href="#page-header" class="element-invisible element-focusable"><?php print t('Skip to menu'); ?></a>
    <?php if(drupal_is_front_page()) {?>
      <a href="#page-highlighted-banner" class="element-invisible element-focusable"><?php print t('Skip to main content'); ?></a>
    <?php }else{ ?>
      <a href="#page-main-content" class="element-invisible element-focusable"><?php print t('Skip to main content'); ?></a>
    <?php } ?>
