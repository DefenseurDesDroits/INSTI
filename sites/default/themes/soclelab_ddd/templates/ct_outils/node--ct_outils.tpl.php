...
<article class="<?php print $classes; ?>" <?php print $attributes; ?>>
  ...
  <div class="container">
      ...
      <?php if( isset($node->field_outils_type_de_contenu['und'][0]['tid'])){ ?>
        <div class="vignette-type">
          <?php $cur_taxo = taxonomy_term_load($node->field_outils_type_de_contenu['und'][0]['tid']); ?>
      ...
      <?php if( isset($node->field_outils_type_de_contenu['und'][0]['tid'])){ ?>
        ...
        <div class="link-more-wrap">
				<a class="link-more"
					href="<?php print slutil_encode_title($cur_taxo->name); ?>"
					title="<?php print $node_url_title; ?>"><?php print t("Every") . " " . $cur_taxo->name; ?></a>
			</div>
        <?php } ?>
      <?php } ?>
    </div>
...
<article class="<?php print $classes; ?>">
    ...
    <?php } elseif (isset($node->field_outils_type_de_contenu['und'][0]['tid'])) { ?>
      <?php $taxo = taxonomy_term_load($node->field_outils_type_de_contenu['und'][0]['tid']); ?>
...
<article
  ...
  <?php if (isset($node->field_article_descriptif) && isset($node->body)) { ?>
    <div class="offre-chapo"><?php print slutil_get_txtvignette($node->field_article_descriptif, $node->body, 150, false); ?><span
			class="ellipsis">...</span>
	</div>
  <?php } ?>
</article>
