...
<article class="<?php print $classes; ?> node-vm-full clearfix"
  ...
  <?php } ?>
	...
	<?php if (isset($content["field_lieu_presentation"])) { ?>
		<div class="node-body-low body-offre text-riche">
		<span class="node-body-bold"><?php print t("Place of presentation: "); ?></span> <?php print $content["field_lieu_presentation"][0]['#markup']; ?>
		</div>
	<?php } ?>
	
	<?php if (isset($content["field_groupe_travail"])) { ?>
		<div class="node-body-low body-offre text-riche">
		<span class="node-body-bold"><?php print t("Working group: "); ?></span> <?php print $content["field_groupe_travail"][0]['#markup']; ?>
		</div>
	<?php } ?>
