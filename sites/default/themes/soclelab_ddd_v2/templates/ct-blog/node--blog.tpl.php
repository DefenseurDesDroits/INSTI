...
<article
  ...
  <?php if (isset($node->field_article_descriptif) && isset($node->body)) { ?>
    <div class="article-chapo"><?php print slutil_get_txtvignette($node->field_article_descriptif, $node->body, 150, false); ?><span
			class="ellipsis">...</span>
	</div>
  <?php } ?>
</article>
...
<article class="<?php print $classes; ?>" <?php print $attributes; ?>>
  ...
  <div class="container">
      ...
      <?php if (isset($node->field_article_descriptif) && isset($node->body)) { ?>
        <div class="carousel-chapo chapo-event"><?php print slutil_get_txtvignette($node->field_article_descriptif, $node->body, 200); ?></div>
      <?php } ?>
