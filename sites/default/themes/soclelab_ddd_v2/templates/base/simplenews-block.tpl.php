...
$block = block_load('simplenews','1704');
$title = $block->title;
?>
<div class="row">
  <nav class="navbar navbar-default">
      <!-- Brand and toggle get grouped for better mobile display -->
        <div class="navbar-header">
          <button type="button" class="navbar-toggle collapsed out" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
            <span class="sr-only"></span>
            <i class="fa fa-chevron-right"></i>
          </button>
          <div class="open-navbrand">
            <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
              <h2 class="navbar-brand"><?php print t($title); ?></h2>
            </button>
          </div>  
        </div>
      <!-- Collect the nav links, forms, and other content for toggling -->
      <div class="collapse-1 navbar-collapse collapse" id="bs-example-navbar-collapse-1">
          <?php if ($message): ?>
